    ...
    <body>
        ...
        <div class="container">
            ...
            <a href="../index.php"><img src="../css/image/logo3.2.png" class="logo"></a>
                <nav>
                    <ul>
                        <li class="contact"><a href="../accomodation/booktorrijos.php">Nearby Hotels & Resto</a></li>
                    </ul>
                </nav>
        ...
        <div class="row">
            <div class="col">
                <h1><?php echo $torrijos->title;?></h1>
                <p><?php echo $torrijos->welcome;?></p>
            </div>
            <div class="col">
                <a href="../spots/poctoy.php"><div class="card card1-91">
                <h5><?php echo $torrijos->poctoy->title;?></h5>
                </div></a>
            </div>
        </div>
        <?php } ?>
