...
$boacMunicipality = $xml->xpath("//municipality[@id='Boac']")[0];
    ...
    <div class="whole">
        ...
        <?php
            ...
            <div  class="main">
                ...
                $filteredPlaces = $xml->xpath("//municipality[@id='Boac']/place[contains(name, '$search') or contains(location, '$search') or contains(description, '$search')]");
