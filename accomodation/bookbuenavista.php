...
$BuenaMunicipality = $xml->xpath("//municipality[@id='Buenavista']")[0];
        ...
        <?php
            ...
            <div  class="main">
                <div  class="left-side">
                    ...
                    <?php foreach ($BuenaMunicipality->place as $place) { ?>
                ...
                $filteredPlaces = $xml->xpath("//municipality[@id='Buenavista']/place[contains(name, '$search') or contains(location, '$search') or contains(description, '$search')]");
