...
$mogpogMunicipality = $xml->xpath("//municipality[@id='Mogpog']")[0];
        ...
        <?php
            ...
            <div  class="main">
                <div  class="left-side">
                    ...
                    <?php foreach ($mogpogMunicipality->place as $place) { ?>
                ...
                $filteredPlaces = $xml->xpath("//municipality[@id='Mogpog']/place[contains(name, '$search') or contains(location, '$search') or contains(description, '$search')]");
