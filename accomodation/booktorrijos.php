...
$TorrijosMunicipality = $xml->xpath("//municipality[@id='Torrijos']")[0];
        ...
        <?php
            ...
            <div  class="main">
                <div  class="left-side">
                    ...
                    <?php foreach ($TorrijosMunicipality->place as $place) { ?>
                ...
                $filteredPlaces = $xml->xpath("//municipality[@id='Torrijos']/place[contains(name, '$search') or contains(location, '$search') or contains(description, '$search')]");
