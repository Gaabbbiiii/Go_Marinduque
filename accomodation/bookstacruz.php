...
$staMunicipality = $xml->xpath("//municipality[@id='StaCruz']")[0];
        ...
        <?php
            ...
            <div  class="main">
                <div  class="left-side">
                    ...
                    <?php foreach ($staMunicipality->place as $place) { ?>
                ...
                $filteredPlaces = $xml->xpath("//municipality[@id='StaCruz']/place[contains(name, '$search') or contains(location, '$search') or contains(description, '$search')]");
