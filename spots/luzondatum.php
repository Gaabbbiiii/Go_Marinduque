...
<html>
    <head>
        ...
        <title>Mogpog</title>
        <link rel="stylesheet" href="../css/luzondatum.css">
    </head>
    <body>
        <div class="front"></div>
        <div class="line"></div>
        ...
        <div class="row">
            <div class="col">
                <h1 class="l0"><?php echo $mogpog->luzondatum->title;?></h1>
                <h1 class="l1"><?php echo $mogpog->luzondatum->description->l1;?></h1>
                <h1 class="l4"><?php echo $mogpog->luzondatum->how;?></h1>
