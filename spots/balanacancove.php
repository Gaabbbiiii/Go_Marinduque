...
<html>
    <head>
        ...
        <title>Mogpog</title>
        <link rel="stylesheet" href="../css/balanacancove.css">
    </head>
    <body>
        <div class="front"></div>
        <div class="line"></div>
        ...
        <div class="row">
            <div class="col">
                <h1 class="l0"><?php echo $mogpog->balanacancove->title;?></h1>
                <h1 class="l1"><?php echo $mogpog->balanacancove->description->l1;?></h1>
                <h1 class="l2"><?php echo $mogpog->balanacancove->description->l2;?></h1>
            </div>
            <div class="col">
