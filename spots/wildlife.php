...
<html>
    ...
    <body>
        ...
        <div class="row">
            <div class="col">
                <h1 class="l0"><?php echo $buenavista->wildlife->title;?></h1>
                <h1 class="l1"><?php echo $buenavista->wildlife->description->l1;?></h1>
                <h1 class="l2"><?php echo $buenavista->wildlife->description->l2;?></h1>
                <h1 class="l4"><?php echo $buenavista->wildlife->things;?></h1>
