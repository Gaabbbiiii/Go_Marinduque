...
<html>
    <head>
        ...
        <title>Mogpog</title>
        <link rel="stylesheet" href="../css/paadjao.css">
    </head>
    <body>
        <div class="front"></div>
        <div class="line"></div>
        ...
        <div class="row">
            <div class="col">
                <h1 class="l0"><?php echo $mogpog->paadjao->title;?></h1>
                <h1 class="l1"><?php echo $mogpog->paadjao->description->l1;?></h1>
                <h1 class="l2"><?php echo $mogpog->paadjao->description->l2;?></h1>
                <h1 class="l3"><?php echo $mogpog->paadjao->description->l3;?></h1>
                <h1 class="l4"><?php echo $mogpog->paadjao->things;?></h1>
