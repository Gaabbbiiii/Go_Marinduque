...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/malindig.css">
    </head>
    <body>
        <div class="front"></div>
        <div class="line"></div>
        ...
        <div class="row">
            <div class="col">
                <h1 class="l0"><?php echo $buenavista->malindig->title;?></h1>
                <h1 class="l1"><?php echo $buenavista->malindig->description->l1;?></h1>
                <h1 class="l4"><?php echo $buenavista->malindig->things;?></h1>
