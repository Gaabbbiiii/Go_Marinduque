...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/maniwaya.css">
    </head>
    <body>
        <div class="front"></div>
        <div class="line"></div>
        ...
        <div class="row">
            <div class="col">
                <h1 class="l0"><?php echo $stacruz->maniwaya->title;?></h1>
                <h1 class="l1"><?php echo $stacruz->maniwaya->description->l1;?></h1>
                <h1 class="l2"><?php echo $stacruz->maniwaya->description->l2;?></h1>
                <h1 class="l3"><?php echo $stacruz->maniwaya->description->l3;?></h1>
                <h1 class="l4"><?php echo $stacruz->maniwaya->things;?></h1>
