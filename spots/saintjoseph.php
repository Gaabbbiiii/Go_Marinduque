...
<html>
    <head>
        ...
        <title>Gasan</title>
        <link rel="stylesheet" href="../css/saintjoseph.css">
    </head>
    <body>
        <div class="front"></div>
        <div class="line"></div>
        ...
        <div class="row">
            <div class="col">
                <h1 class="l0"><?php echo $gasan->saintjoseph->title;?></h1>
                <h1 class="l1"><?php echo $gasan->saintjoseph->description->l1;?></h1>
                <h1 class="l2"><?php echo $gasan->saintjoseph->description->l2;?></h1>
                <h1 class="l3"><?php echo $gasan->saintjoseph->description->l3;?></h1>
                <h1 class="l4"><?php echo $gasan->saintjoseph->things;?></h1>
