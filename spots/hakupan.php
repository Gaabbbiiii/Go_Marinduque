...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/hakupan.css">
    </head>
    <body>
        <div class="front"></div>
        <div class="line"></div>
        ...
        <div class="row">
            <div class="col">
                <h1 class="l0"><?php echo $stacruz->hakupan->title;?></h1>
                <h1 class="l1"><?php echo $stacruz->hakupan->description->l1;?></h1>
                <h1 class="l4"><?php echo $stacruz->hakupan->things;?></h1>
